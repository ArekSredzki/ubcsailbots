...
def run(Waypoint1,Waypoint2,Waypoint3):
    ...
    interpolatedPoint = datatypes.GPSCoordinate((PortStartInnerPoint.lat+StarboardStartInnerPoint.lat)/2,(PortStartInnerPoint.longitude+StarboardStartInnerPoint.long)/2)
